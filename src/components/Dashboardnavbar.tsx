      ...
      <div className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-8 py-3 h-16">
          <div className="font-bold text-2xl text-gray-800">
            <a href="#">Animal Market</a>
          </div>
          
          <div className="hidden md:flex items-center gap-6">
            <a href="#" className="text-gray-800 font-medium border-b-2 border-blue-500">Dashboard</a>
            <a href="#" className="text-gray-500 hover:text-blue-500 relative">
              Messages
            ...
            <a href="#" className="text-gray-500 hover:text-blue-500">Favorites</a>
          </div>
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                <div className="absolute top-[calc(100%+0.5rem)] right-0 w-64 bg-white rounded-lg shadow-lg overflow-hidden z-50 border border-gray-200">
                  ...
                  <div className="py-2">
                    <a className="flex items-center gap-3 px-4 py-3 text-gray-800 hover:bg-gray-50 text-[0.9rem]" href="#">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V7.414l-5-5H3zm7 2v3.586l3.293 3.293a1 1 0 01.293.707V16a1 1 0 01-1 1H5a1 1 0 01-1-1V4a1 1 0 011-1h4.586a1 1 0 01.707.293l3 3z" clipRule="evenodd" />
                      </svg>
                      Sign out
                    </button>
                  </div>
