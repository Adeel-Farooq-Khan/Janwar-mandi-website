    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-sm transition-all hover:translate-y-[-5px] hover:shadow-lg cursor-pointer">
      <div className="relative h-52">
        ...
        <button
          ...
          className={`absolute top-3 left-3 bg-white/80 hover:bg-white w-8 h-8 rounded-full flex items-center justify-center transition-all ${
            animal.favorite ? "text-red-500" : "text-gray-400"
          }`}
        >
          <FaHeart />
        </button>
